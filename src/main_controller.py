...
class MainController:
    ...
    def start_copy(self):
        try:
            ...
            self._validate_custom_file_types(file_type, custom_file_types)
            ...
            copy_options = CopyOptions(
                ...
                file_type,
                compress_after_copy,
                self._convert_file_type_to_list(custom_file_types),
            )
    ...
    def _convert_file_type_to_list(self, text: str):
        return text.split(" ")

    def _validate_custom_file_types(self, file_type: FileType, custom_file_types: str):
